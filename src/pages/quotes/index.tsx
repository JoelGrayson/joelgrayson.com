...
export default function Quotes() {
    return <Page seo={{
        ...
        {/* <Quote date='5.20.24'>
            The logarithmic return rule: after a certain point, the longer you do something, the less you get out of it. You will get more out of the first year of doing something than the fifth year.
            <Image src='/image/logarithmic-returns.jpg' alt='Logarithmic return rule' width={300} height={300} />
        </Quote> */}

        <Quote date='5.20.24'>Ask five people each with an 80% chance of saying no, and there is a 67% chance at least one of them will say yes.</Quote>
