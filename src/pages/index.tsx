...
export default function Home() {
    ...
    return <Page noPadding pathname='/' seo={{
        ...
        <div className="w-full max-w-[680px] px-4 mx-auto pt-8 pb-1 leading-8">
            <p className='indent-8'>Hi, I'm Joel. I like to learn and work on projects. My apps have 10,000+ users with $1,000+ in revenue. <Link href='https://apps.apple.com/us/app/edit-time/id6464405876' target='_blank'>Edit Time</Link> changes file creation dates, <Link href='https://buseroo.com' target='_blank'>Buseroo.com</Link> calculates which school bus goes to any address, <Link href='https://chromewebstore.google.com/detail/homework-checker-schoolog/aflepcmbhmafadnddmdippaajhjnmohj' target='_blank'>Homework Checker</Link> helps manage homework, and <Link href='https://chromewebstore.google.com/detail/focus-for-google-docs/djnloioaddlnmagobbcnjpppmbelfocf' target='_blank'>Focus for Google Docs</Link> is a tool to enter the writing flow. I built a <Link href='https://youtu.be/bHHk2FL5Ujs' target='_blank'>vending machine</Link> that served snacks in the school hallway, <Link href='/machines#jacob-s-ladder' target='_blank'>Jacob&apos;s ladder</Link> that acted as my morning alarm, and <Link href='/machines#wooden-pinball-machine' target='_blank'>wooden pinball machine</Link>. Regarding climate change, I helped plan a <Link href='/combating-climate-change#solar-for-riverdale' target='_blank'>493 kW solar installation</Link> for Riverdale Country School, founded <Link href='https://studentsforelectricbuses.org' target='_blank'>Students for Electric Buses</Link> to help transition Riverdale's bus provider to electric school buses, and did <Link href='/research/organic-optoelectronics' target='_blank'>research on organic solar cells</Link> at New York University's Lee Lab. In my community, I served on Manhattan Community Board One. I also run a <Link href='https://youtube.com/@JoelGrayson'>comedy YouTube channel</Link> with my Dad.</p>
