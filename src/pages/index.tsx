...
export default function Home() {
    ...
    return <Page noPadding pathname='/' seo={{
        ...
        <div className="w-full max-w-[680px] px-4 mx-auto pt-8 pb-1 leading-8">
            <p className='indent-8'>Hi, I&apos;m Joel. I&apos;m currently studying electrical engineering and computer science at Stanford and am interning at xAI (working on the electrical team for the data centers). My apps have over 10,000 users with $4,000 in revenue. I&apos;ve worked on many projects so far and look forward to many more in the future. <Link href='https://apps.apple.com/us/app/edit-time/id6464405876?pt=126612879&ct=web' target='_blank'>Edit Time</Link> changes file creation dates, <Link href='https://buseroo.com' target='_blank'>Buseroo.com</Link> calculates which school bus goes to any address, <Link href='https://chromewebstore.google.com/detail/homework-checker-schoolog/aflepcmbhmafadnddmdippaajhjnmohj?utm_source=jgcom&utm_campaign=web&utm_medium=site' target='_blank'>Homework Checker</Link> helps manage homework, <Link href='https://chromewebstore.google.com/detail/focus-for-google-docs/djnloioaddlnmagobbcnjpppmbelfocf?utm_source=jgcom&utm_campaign=web&utm_medium=site' target='_blank'>Focus for Google Docs</Link> is a tool to enter the writing flow, and <Link href='https://shanghaidictionary.com' target='_blank'>ShanghaiDictionary.com</Link> has had thousands of searches translating between Shanghainese, Mandarin, and English. I like to build machines, like a <Link href='https://youtu.be/bHHk2FL5Ujs' target='_blank'>vending machine</Link> that served snacks in the school hallway. Regarding climate change, I helped plan a <Link href='/combating-climate-change#solar-for-riverdale' target='_blank'>109 kW solar installation</Link> for Riverdale Country School, founded <Link href='https://studentsforelectricbuses.org' target='_blank'>Students for Electric Buses</Link> to help transition Riverdale&apos;s bus provider to electric school buses, and did <Link href='/research/organic-optoelectronics' target='_blank'>research on organic solar cells</Link> at New York University&apos;s Lee Lab. In my community, I served on Manhattan Community Board One. I also run a <Link href='https://youtube.com/@JoelGrayson'>comedy YouTube channel</Link> with my Dad</p>
            {/* <p>Regarding software for learning Chinese, I made ChineseIsFun.com, and <Link href='https://shanghaidictionary.com' target='_blank'>ShanghaiDictionary.com</Link>, the world&apos;s first translator and dictionary for Shanghainese.</p> */}
        </div>
