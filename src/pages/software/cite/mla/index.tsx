...
export default function MLACite() {
    return <Page bottomPadding seo={{
        ...
        <ul>
            <li>
                In general, MLA citations take the form <code>author</code>, <code>title of source</code>, <code>container</code>.
                <ul>
            ...
            <li>Dates are in the <code>{'{day number}{month name}{year}'}</code> format.</li>
