...
export default function HomeworkChecker() {
    return <Page seo={{
        ...
        <div className='buttons'>
            <Link target='_blank' href='https://chromewebstore.google.com/detail/homework-checker-schoolog/aflepcmbhmafadnddmdippaajhjnmohj?utm_source=jgcom&utm_campaign=web&utm_medium=site'>
