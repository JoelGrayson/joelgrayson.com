...
export default function index() {
    return (<Page padding>
        ...
        <div className='flex'>
            ...
            <a href='https://github.com/JoelGrayson/Icosahedron-Navigation' className={`${styles['btn-icon']} unstyled ml-1`} target='_blank'>
                <Button>
