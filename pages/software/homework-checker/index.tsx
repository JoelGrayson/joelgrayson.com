...
export default function HomeworkChecker() {
    return (<Page padding>
        ...
        {/* Buttons */}
        <link rel="stylesheet" href="/styles/btn-icon.css" />
        <div className="buttons">
            <a target="_blank" className="btn-icon" href="https://chrome.google.com/webstore/detail/homework-checker-schoolog/aflepcmbhmafadnddmdippaajhjnmohj/">
            ...
            <a target="_blank" className="btn-icon" href="https://github.com/JoelGrayson/Homework-Checker">
        ...
        <table id="j_table">
            <tbody>
                ...
                <tr> {/* images */}
                    <td>
                        <img width="200px" alt="default" src="/software/homework-checker/regular.jpg" />
                    </td>
                    <td>
                        <img width="200px" alt="demo" src="/software/homework-checker/with-homework-checker.jpg" />
                    </td>
                </tr>
                <tr> {/* explanation */}
                    <td>
