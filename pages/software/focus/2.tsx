    ...
    return <Page noheader nopadding>
        <div style={{backgroundColor: '#e5e5e5'}}>
            <Container>
                ...
                <a href='https://chrome.google.com/webstore/detail/focus-for-google-docs/djnloioaddlnmagobbcnjpppmbelfocf' target='_blank' className='unstyled' rel='noreferrer'>
                    <Button>
                ...
                <a href='https://github.com/JoelGrayson/Focus' rel='noreferrer' target='_blank' className='unstyled'>
                    <Button>
