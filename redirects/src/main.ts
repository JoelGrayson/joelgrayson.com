...
export default async function Redirects() { //returns function to get redirect objects for next.config.js. Only async ∵ next.js documentation requires async functions for redirect value
