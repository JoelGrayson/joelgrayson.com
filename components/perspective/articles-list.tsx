...
export const articles: article[]=[
    { name: 'The Importance of Phase in Quantum Mechanics', hyphenatedName: 'the-importance-of-phase-in-quantum-mechanics', date: new Date('Feb 20, 2023'), category: 'science' },
