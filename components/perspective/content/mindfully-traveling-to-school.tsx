...
export default function MindfullyTravelingToSchool() {
    return <div>
        ...
        <Image src='/perspective/mindfully-traveling-to-school/Biking to School square.jpg' alt='Biking to School' width='250' height='242' style={{ float: 'right', marginLeft: 20 }} />
        ...
        <p>The journey had additional after-effects. Three hours of traveling in solitude made me feel more self-sufficient because I learned that I did not need a driver to travel to school. Afterward, I felt surprisingly energized, not tired. Perhaps the new experiences gave me vigor. Traveling fifteen miles by myself even made me mindful of my place in the universe. Finally, I will never again complain about walking from 9/10 to Lindenbaum.</p>
        
        <br /><br />
        <Image src='/perspective/mindfully-traveling-to-school/Map.jpg' alt='Map' width='110' height='378' />
    </div>;
}
