...
export default function WhyWeNeedNuclearEnergy() {
    return <div>
        ...
        <Image src="/perspective/why-we-need-nuclear-energy/nuclear-death-rates.png" alt="nuclear-death-rates" height='278' width='330' style={{ float: 'left', marginRight: 30 }} />
        ...
        <div className='grid place-items-center my-3'>
            <Image src="/perspective/why-we-need-nuclear-energy/France vs Brazil's Electricity Sources.png" alt="France vs Brazil's Electricity Sources" height='225' width='640' />
        </div>
        ...
        <h2>Costs</h2>
        <Image src="/perspective/why-we-need-nuclear-energy/Nuclear vs. Gas Power Plant Profits (1000 MWe).jpg" alt="Nuclear vs. Gas Power Plant Profits (1000 MWe)" height='278' width='330' style={{ float: 'right', marginLeft: 30 }} />
